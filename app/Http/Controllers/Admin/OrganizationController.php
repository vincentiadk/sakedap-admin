...
class OrganizationController extends Controller
{
    public function index()
    {
        $data = [
            ...
            'content' => 'admin.master.organization'
        ];
    ...
    public function datatable(Request $request)
    {
        ...
        if (empty($search)) {
            $queryData = Organization::offset($start)
                ->limit($length)
                ->orderBy($order, $dir)
                ->get();
            $totalFiltered = Organization::count();
        } else {
            $queryData = Organization::where(function ($query) use ($search) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            $old_data = Organization::find($id);
            $new_data = Organization::find($id);
    ...
    {
        $destroy = Organization::where('id', $id)->delete();
        $data    = Organization::withTrashed()->find($id);
