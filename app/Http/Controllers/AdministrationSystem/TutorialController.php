...
class TutorialController extends Controller
{
    public function index()
    {
        return view('layouts.index', [
            'data' => [
                ...
                'content' => 'administration-system.tutorial',
                'plugins' => [
                    'datatable',
                    'select2',
                    'summernote',
    ...
    public function datatable(Request $request)
    {
        ...
        $whereClause = '';
        $whereCondition[] = "(e_news.deleted_at is null and e_news.flag = 'TUTORIAL')";
                ...
                $action = '
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a href="' . url('administration-system/tutorial/preview/' . $val->ID) . '" class="dropdown-item">
    ...
    public function preview($id)
    {
        ...
        return view('layouts.index', [
            'data' => [
                'news' => $news,
                'content' => 'administration-system.tutorial-preview',
            ]
        ]);
    }
