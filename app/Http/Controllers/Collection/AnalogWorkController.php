...
class AnalogWorkController extends Controller
{
    private $worksheetCategory;

    public function __construct()
    {
        $this->worksheetCategory = Main::COLLECTION_ANALOG;
    }
    ...
    public function index()
    {
        return view('layouts.index', [
            'data' => [
                ...
                'content' => 'collection.analog-work',
                'plugins' => [
                    'datatable',
                    'daterangepicker',
                    'select2',
    ...
    public function datatable(Request $request)
    {
        ...
        if ($queryData) {
            foreach ($queryData as $val) {
                $action = '
                    <a href="' . url('collection/analog-work/detail/' . $val->ID) . '" class="btn btn-primary btn-sm">
