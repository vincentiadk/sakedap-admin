...
class WatermarkFilm implements ShouldQueue
{
    ...
    {
        Storage::disk($this->location->location)->makeDirectory('public/collection/film/preview/' . $this->collMedia->collection_id);
        Storage::disk($this->location->location)->makeDirectory('public/collection/film/watermark/' . $this->collMedia->collection_id);
        ...
        $path_preview =  Storage::disk($this->location->location)->path('public/collection/film/preview/' . $this->collMedia->collection_id . '/' . $filename_preview);

        $filename_watermark = \Str::random(40) . '.mp3';
        $path_watermark =  Storage::disk($this->location->location)->path('public/collection/film/watermark/' . $this->collMedia->collection_id . '/' . $filename_watermark);
        ...
        GeneralHelper::videoCut($this->dirOriginal, $path_preview, $prev_start, $prev_end);
        GeneralHelper::videoWatermark($this->dirOriginal, $path_watermark);
