    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Tambah Data Audio</h3><br>
                                    ...
                                    <form id="form_data" class="form">
                                        ...
                                        <p>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="album" id="album" placeholder="Masukan album">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2">ISRC :</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="code" id="code" placeholder="Masukan kode ISRC">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2">Preview Start :</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="preview_start" id="preview_start" class="form-control" placeholder="Ex: 00:30">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2">Preview End :</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="preview_end" id="preview_end" class="form-control" placeholder="Ex: 01:02">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="alert alert-warning">
                                            <small>
                                                Jenis File Yang di Dukung <b>: MPEG, MPGA, MP3, WAV</b><br>
...
<script>
    $(function() {
        ...
        dragFile('.file-content', ['mpeg', 'mpega', 'mp3', 'wav']);
    });
    ...
    function create() {
        $.ajax({
            url: '{{ url("admin/collection/create_manual/5") }}',
            type: 'POST',
            dataType: 'JSON',
