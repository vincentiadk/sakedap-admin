                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="code" id="code" class="form-control" style="width:100%;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-2">Kepengarangan</label>
                                    <div class="col-md-10">
                                        <input type="text" name="kepeng" id="kepeng" class="form-control" style="width:100%;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        <div role="tabpanel" class="tab-pane active" id="tab_detail" aria-expanded="true">
                                            <p>
                                                <table class="table table-striped table-bordered display" id="datatable_serverside_detail">
                                        ...
                                        <div class="tab-pane" id="tab_summary">
                                            <p>
                                                <table class="table table-striped table-bordered display" id="datatable_serverside_summary">
                                                    <thead class="text-center">
                                                        <tr>
                                                            <th>No</th>
                                                            <th>Penerbit</th>
