		...
		<div class="content-header row">
				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('admin/collection/problem/1') }}">Buku Bermasalah</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('admin/collection/problem/1') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
											...
											<div role="tabpanel" class="tab-pane active" id="tab_general" aria-expanded="true">
												<p>
													...
													<div class="form-group">
														<label>Dimensi :</label>
														<div class="input-group mb-2">
															<input type="number" name="dimension" id="dimension" class="form-control" placeholder="Masukan dimensi" value="{{ isset($collection->physicalDescription()->dimension) ? $collection->physicalDescription()->dimension : '' }}">
															<div class="input-group-prepend">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select name="contributor_id_field" id="contributor_id_field" class="form-control select2" style="width:100%;">
																	...
																	<tbody id="edition_element">
																		@foreach($collection->edition()->get() as $key => $e)
																			<tr class="text-center">
																				...
																				<td>
																					<a href="{{ url('admin/collection/update/' . $e->id) }}" class="btn btn-warning btn-sm"><i class="la la-edit"></i> Edit</a>
																				</td>
																			</tr>
																		@endforeach
																	</tbody>
