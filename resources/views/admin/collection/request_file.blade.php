                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="text-right">
                      <span class="badge bg-warning font-weight-bold"><span style="font-size:15px;">{{ $total_1_request }}</span> Permintaan Baru / Belum Diproses</span>
                      <span class="badge bg-teal font-weight-bold"><span style="font-size:15px;">{{ $total_2_request }}</span> Permintaan Diterima</span>
                      <span class="badge bg-danger font-weight-bold"><span style="font-size:15px;">{{ $total_3_request }}</span> Permintaan Ditolak</span>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
  $(function() {
    ...
    select2AutoSuggest('#validated_by', 'load_user');
  });
  ...
  function loadDataTable() {
    $('#datatable_serverside').DataTable({
      ...
      ajax: {
        url: '{{ url("admin/collection/request/datatable") }}',
        data: {
