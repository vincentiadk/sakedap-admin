<table>
    <thead>
        <tr>
            <th rowspan="2" colspan="11" style="font-size:18px; font-weight:bold; border:1px solid black; text-align:center; vertical-align:center;">TAGIHAN ISBN</th>
        </tr>
    </thead>
</table><br>
...
<table>
    ...
    <tbody>
        @if(count($data) > 0)
            @foreach($data as $key => $d)
                @php
                    ...
                    $collection        = App\Models\Collection::where('code', $code)->where('parent_id', 0)->first();
                @endphp
                ...
                <tr>
                    ...
                    <td style="">
                        @isset($d['received_date']) Telah Diserahkan @else Belum Diserahkan @endif
                    </td>
                    <td style="">
        ...
        @else
            <tr>
                <td colspan="11" style="font-size:10px; font-weight:bold; border:1px solid black; text-align:center; vertical-align:center;">Tidak Ada Data</td>
            </tr>
        @endif
    </tbody>
</table>
