    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Tambah Data Film</h3><br>
                                    ...
                                    <form id="form_data" class="form">
                                        ...
                                        <p>
                                            <div class="form-group row">
                                                <label class="col-md-2">Rumah Produksi :</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="code" id="code" placeholder="Masukan kode ISAN">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2">Preview Start :</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="preview_start" id="preview_start" class="form-control" placeholder="Ex: 01:30:00">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-2">Preview End :</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="preview_end" id="preview_end" class="form-control" placeholder="Ex: 02:03:07">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" name="duration" id="duration" class="form-control" placeholder="Masukan durasi">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="alert alert-warning">
                                            <small>
                                                Jenis File Yang di Dukung <b>: MKV, MP4, AVI, MPEG, 3GP</b><br>
                                                Maksimal Ukuran File <b>: 5GB</b>
                                            </small>
                                        </div>
                                        <div class="form-group">
...
<script>
    $(function() {
        ...
        dragFile('.file-content', ['mkv', 'mp4', 'avi', 'mpeg', '3gp']);
    });
    ...
    function create() {
        $.ajax({
            url: '{{ url("admin/collection/create_manual/6") }}',
            type: 'POST',
            dataType: 'JSON',
