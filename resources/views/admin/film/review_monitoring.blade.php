	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Review Film</h3><br>
															...
															<th colspan="2">
																<div class="row justify-content-center">
																	<div class="col-md-8">
																		...
																		@if($original && Storage::disk('local')->exists($original->link))
																			<div class="row justify-content-center">
																				<div class="col-md-6">
																			...
																			<center>
																				<div class="embed-responsive embed-responsive-16by9">
																					<video width="100%" height="240" controls controlsList="nodownload">
																						<source src="{{ asset(Storage::disk('local')->url($original->link)) }}" type="{{ $original->mimes }}">
