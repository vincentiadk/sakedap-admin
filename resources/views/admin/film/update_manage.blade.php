		...
		<div class="content-header row">
				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('admin/collection/manage/6') }}">Pengelolaan</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('admin/collection/create_manual/6') }}" class="btn btn-primary">Tambah Data Baru</a>
					<a href="{{ url('admin/collection/manage/6') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
									...
									<form method="POST" action="{{ $collection->lock ? $locked_url : '' }}" enctype="multipart/form-data" class="form">
										...
										<p>
											<div class="form-group">
												...
												@if($watermark && Storage::disk('local')->exists($watermark->link))
													...
													<center>
														<div class="embed-responsive embed-responsive-16by9">
															<video width="100%" height="240" controls controlsList="nodownload">
																<source src="{{ asset(Storage::disk('local')->url($watermark->link)) }}" type="{{ $watermark->mimes }}">
