    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Detail Buku</h3><br>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                                    ...
                                                                    <div class="carousel-item active">
                                                                        <img class="d-block w-100 ezoom" src="" id="data_image_pdf" style="max-height:903px; width:100%;">
                                                                    </div>
                                                                    </div>
                                                                </div>
                                                                </div>
                                                        ...
                                                        @if($watermark && count($watermark->jsonParse()) > 0)
                                                            ...
                                                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                                ...
                                                                @foreach($watermark->jsonParse() as $key => $w)
                                                                    @if($key == 0)
                                                                    <div class="carousel-item active">
                                                                        <img class="d-block w-100" src="{{ $w }}" alt="First slide" style="height:903px;">
                                                                    </div>
                                                                    @else
