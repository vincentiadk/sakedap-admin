    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Detail Film</h3><br>
                                            ...
                                            <p>
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="align-middle w-20 font-weight-bold">Rumah
                                                                    Produksi</td>
                                                            ...
                                                            <tr>
                                                                <td class="align-middle w-20 font-weight-bold">ISAN
                                                                </td>
