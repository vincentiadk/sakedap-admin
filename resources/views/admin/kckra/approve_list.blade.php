                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Daftar Koleksi Belum Diterima</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="type" id="type" class="form-control"
                                                        ...
                                                        @foreach ($types as $id_type => $type)
                                                            <option
                                                                @if (
                                                                    !empty(session('filter.collection.kckra.approval.type')) &&
                                                                        $id_type == session('filter.collection.kckra.approval.type')) selected="selected" @endif
                                                                value="{{ $id_type }}">
                                                                {{ $type }}
                                                            </option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="title" id="title" class="form-control" style="resize:none;">{{ session('filter.collection.kckra.approval.title') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="publisher_id" id="publisher_id" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.approval.publisher_id')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.approval.publisher_id') }}"
                                                                selected="selected">
                                                                {{ App\Models\Publisher::select('name')->where('id', session('filter.collection.kckra.approval.publisher_id'))->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="province_id" id="province_id" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.approval.province_id')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.approval.province_id') }}"
                                                                selected="selected">
                                                                {{ App\Models\Province::where('id', session('filter.collection.kckra.approval.province_id'))->select('name')->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="city" id="city" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.approval.city')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.approval.city') }}"
                                                                selected="selected">
                                                                {{ App\Models\City::select('name')->where('id', session('filter.collection.kckra.approval.city'))->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="manage" id="manage" class="form-control">
                                                        @foreach ($manages as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.approval.manage') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="validated" id="validated" class="form-control">
                                                        @foreach ($validated as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.approval.validated') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="edited" id="edited" class="form-control">
                                                        @foreach ($validated as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.approval.edited') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" name="publication_year"
                                                        ...
                                                        value="{{ session('filter.collection.kckra.approval.publication_year') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="code" id="code"
                                                        class="form-control"
                                                        value="{{ session('filter.collection.kckra.approval.code') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <select name="year_start" id="year_start"
                                                                ...
                                                                @for ($i = 2018; $i <= date('Y'); $i++)
                                                                    <option value="{{ $i }}"
                                                                        {{ $i == session('filter.collection.kckra.approval.year_start') ? 'selected' : '' }}>
                                                                        {{ $i }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="year_end" id="year_end"
                                                                ...
                                                                @for ($i = 2018; $i <= date('Y'); $i++)
                                                                    <option value="{{ $i }}"
                                                                        {{ $i == session('filter.collection.kckra.approval.year_end') ? 'selected' : '' }}>
                                                                        {{ $i }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="month_start" id="month_start"
                                                                        ...
                                                                        @foreach ($month as $key => $value)
                                                                            <option value="{{ $value }}"
                                                                                {{ $value == session('filter.collection.kckra.approval.month_start') ? 'selected' : '' }}>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select name="month_year_start"
                                                                        ...
                                                                        @for ($i = 2018; $i <= date('Y'); $i++)
                                                                            <option value="{{ $i }}"
                                                                                {{ $i == session('filter.collection.kckra.approval.month_year_start') ? 'selected' : '' }}>
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <select name="month_end" id="month_end"
                                                                        ...
                                                                        @foreach ($month as $key => $value)
                                                                            <option value="{{ $value }}"
                                                                                {{ $value == session('filter.collection.kckra.approval.month_end') ? 'selected' : '' }}>
                                                                                {{ App\Helper\GeneralHelper::getMonth($value) }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select name="month_year_end" id="month_year_end"
                                                                        ...
                                                                        @for ($i = 2018; $i <= date('Y'); $i++)
                                                                            <option value="{{ $i }}"
                                                                                {{ $i == session('filter.collection.kckra.approval.month_year_end') ? 'selected' : '' }}>
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="date" name="day_start" id="day_start"
                                                                ...
                                                                value="{{ empty(session('filter.collection.kckra.approval.day_start')) ? date('Y-m-d') : session('filter.collection.kckra.approval.day_start') }}">
                                                        </div>
                                                        <div class="col-md-1">
                                                            <p style="line-height:40px;" class="text-center">s/d</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="date" name="day_end" id="day_end"
                                                                class="form-control" max="{{ date('Y-m-d') }}"
                                                                value="{{ empty(session('filter.collection.kckra.approval.day_end')) ? date('Y-m-d') : session('filter.collection.kckra.approval.day_end') }}">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <button type="button" class="btn btn-primary col-12"
                                    ...
                                    <table class="table table-striped table-bordered display nowrap"
                                        ...
                                        <thead class="text-center">
                                            <tr>
                                                ...
                                                <th>Registrasi Province</th>
                                                <th>Registrasi National</th>
                                                <th>Penerbit</th>
                                                <th>Judul</th>
                                                <th>ISBN</th>
                                                <th>Terima Province</th>
                                                <th>Terima National</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
...
<script>
    $(function() {
        let param = "{{ session('filter.collection.kckra.approval.param') }}"
    ...
    function loadDataTable(param = '') {
        $('#datatable_serverside').DataTable({
            ...
            iDisplayInLength: 10,
            ajax: {
                url: '{{ url('admin/collection/kckra/approval_datatable') }}',
                data: {
                    param: param,
                    title: $('#title').val(),
                    type: $('#type').val(),
            ...
            columns: [{
                ...
                {
                    name: 'terima_province',
                    searchable: false,
                    className: 'align-middle text-center'
                },
                {
                    name: 'terima_national',
                    searchable: false,
                    className: 'align-middle text-center'
                }
            ],
