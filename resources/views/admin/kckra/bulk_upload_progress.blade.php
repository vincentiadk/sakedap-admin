    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Progress Bulk Upload KCKRA</h3><br>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ url('admin/collection/bulk_upload') }}">Bulk Upload
                                    KCKRA</a></li>
            ...
            <div class="content-header-right col-md-6 col-12 mb-2 mt-1">
                <div class="float-md-right">
                    <div class="form-group">
                        <a href="{{ url('admin/collection/kckra/bulk_upload') }}" class="btn btn-secondary"><i
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-success btn-sm" id="btn_load_progress"
                    onclick="loadDetailProgress()"><i class="la la-refresh"></i></button>
            </div>
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            iDisplayInLength: 10,
            ajax: {
                url: '{{ url('admin/collection/kckra/bulk_upload/progress/datatable') }}'
            },
            columns: [{
                    name: 'id',
                    searchable: false,
    ...
    function loadDetailProgress(param) {
        $.ajax({
            url: '{{ url('admin/collection/kckra/bulk_upload/progress/show') }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: param
