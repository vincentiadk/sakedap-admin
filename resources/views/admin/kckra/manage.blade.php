            ...
            <section id="configuration">
                ...
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="type" id="type" class="form-control"
                                                        ...
                                                        @foreach ($types as $id_type => $type)
                                                            <option
                                                                @if (
                                                                    !empty(session('filter.collection.kckra.manage.type')) &&
                                                                        $id_type == session('filter.collection.kckra.manage.type')) selected="selected" @endif
                                                                value="{{ $id_type }}">
                                                                {{ $type }}
                                                            </option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="title" id="title" class="form-control" style="resize:none;">{{ session('filter.collection.kckra.manage.title') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="publisher_id" id="publisher_id" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.manage.publisher_id')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.manage.publisher_id') }}"
                                                                selected="selected">
                                                                {{ App\Models\Publisher::select('name')->where('id', session('filter.collection.kckra.manage.publisher_id'))->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="province_id" id="province_id" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.manage.province_id')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.manage.province_id') }}"
                                                                selected="selected">
                                                                {{ App\Models\Province::where('id', session('filter.collection.kckra.manage.province_id'))->select('name')->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="city" id="city" class="form-control"
                                                        style="width:100%;">
                                                        @if (!empty(session('filter.collection.kckra.manage.city')))
                                                            <option
                                                                value="{{ session('filter.collection.kckra.manage.city') }}"
                                                                selected="selected">
                                                                {{ App\Models\City::select('name')->where('id', session('filter.collection.kckra.manage.city'))->first()->name }}
                                                            </option>
                                                        @endif
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="manage" id="manage" class="form-control">
                                                        @foreach ($manages as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.manage.manage') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="validated" id="validated" class="form-control">
                                                        @foreach ($validated as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.manage.validated') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="edited" id="edited" class="form-control">
                                                        @foreach ($validated as $key => $value)
                                                            <option value="{{ $key }}"
                                                                {{ $key == session('filter.collection.kckra.manage.edited') ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" name="publication_year"
                                                        ...
                                                        value="{{ session('filter.collection.kckra.manage.publication_year') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="code" id="code"
                                                        class="form-control"
                                                        value="{{ session('filter.collection.kckra.manage.code') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <select name="year_start" id="year_start"
                                                                ...
                                                                @for ($i = 2018; $i <= date('Y'); $i++)
                                                                    <option value="{{ $i }}"
                                                                        {{ $i == session('filter.collection.kckra.manage.year_start') ? 'selected' : '' }}>
                                                                        {{ $i }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="year_end" id="year_end"
                                                                ...
                                                                @for ($i = 2018; $i <= date('Y'); $i++)
                                                                    <option value="{{ $i }}"
                                                                        {{ $i == session('filter.collection.kckra.manage.year_end') ? 'selected' : '' }}>
                                                                        {{ $i }}</option>
                                                                @endfor
                                                            </select>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="month_start" id="month_start"
                                                                        ...
                                                                        @foreach ($month as $key => $value)
                                                                            <option value="{{ $value }}"
                                                                                {{ $value == session('filter.collection.kckra.manage.month_start') ? 'selected' : '' }}>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select name="month_year_start"
                                                                        ...
                                                                        @for ($i = 2018; $i <= date('Y'); $i++)
                                                                            <option value="{{ $i }}"
                                                                                {{ $i == session('filter.collection.kckra.manage.month_year_start') ? 'selected' : '' }}>
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <select name="month_end" id="month_end"
                                                                        ...
                                                                        @foreach ($month as $key => $value)
                                                                            <option value="{{ $value }}"
                                                                                {{ $value == session('filter.collection.kckra.manage.month_end') ? 'selected' : '' }}>
                                                                                {{ App\Helper\GeneralHelper::getMonth($value) }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select name="month_year_end" id="month_year_end"
                                                                        ...
                                                                        @for ($i = 2018; $i <= date('Y'); $i++)
                                                                            <option value="{{ $i }}"
                                                                                {{ $i == session('filter.collection.kckra.manage.month_year_end') ? 'selected' : '' }}>
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="date" name="day_start" id="day_start"
                                                                ...
                                                                value="{{ empty(session('filter.collection.kckra.manage.day_start')) ? date('Y-m-d') : session('filter.collection.kckra.manage.day_start') }}">
                                                        </div>
                                                        <div class="col-md-1">
                                                            <p style="line-height:40px;" class="text-center">s/d</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="date" name="day_end" id="day_end"
                                                                class="form-control" max="{{ date('Y-m-d') }}"
                                                                value="{{ empty(session('filter.collection.kckra.manage.day_end')) ? date('Y-m-d') : session('filter.collection.kckra.manage.day_end') }}">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <button type="button" class="btn btn-primary col-12"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Daftar Pengelolaan KCKRA</h4>
                            </div>
...
<script>
    $(function() {
        let param = "{{ session('filter.collection.kckra.manage.param') }}"
        ...
        $('#datatable_serverside tbody').on('click', 'td.level-1', function() {
            // console.log('test')
            var tr = $(this).closest('tr');
            var row = $('#datatable_serverside').DataTable().row(tr);
            var is_serial = row.data().is_serial;
    ...
    function loadDataTable(param = '') {
        $('#datatable_serverside').DataTable({
            ...
            iDisplayInLength: 10,
            ajax: {
                url: '{{ url('admin/collection/kckra/manage/datatable') }}',
                data: {
                    param: param,
                    title: $('#title').val(),
                    type: $('#type').val(),
            ...
            columns: [{
                    className: 'details-control level-1',
                    orderable: false,
                    data: null,
                    defaultContent: ''
                },
    ...
    function createChildCopy(row) {
        // This is the table we'll convert into a DataTable
        var tableCopy = $('<table class="display" width="100%"/>');

        // Display it the child row
        row.child(tableCopy).show();

        // Initialise as a DataTable
        var param = 'index';
        var collection_id = row.data().id;
        var type = 'notall';
        // console.log(collection_id, type);
        var copyTable = tableCopy.DataTable({
            processing: true,
            serverSide: true,
            order: [
                [0, 'desc']
            ...
            searchDelay: 350,
            ajax: {
                url: '{{ url('admin/collection/kckra/datatable_copies') }}' + '/' + collection_id + '/' + type,
                data: {
                    param: param,
                },
                method: 'POST',
    ...
    function createChildEdition(row) {
        // This is the table we'll convert into a DataTable
        var tableEdition = $('<table class="display datatable_serverside_edition table" width="100%"/>');
        // Display it the child row
        row.child(tableEdition).show();

        // Initialise as a DataTable
        var param = 'index';
        var collection_id = row.data().id;
        var editionTable = tableEdition.DataTable({
            processing: true,
            serverSide: true,
            destroy: true,
            order: [
            ...
            columns: [{
                    title: '#',
                    className: 'details-control level-2',
                    orderable: false,
                    data: null,
                    defaultContent: ''
                },
        ...
        $('.datatable_serverside_edition tbody').on('click', 'td.level-2', function() {
            var tr = $(this).closest('tr');
            var row = $('.datatable_serverside_edition').DataTable().row(tr);
    ...
    function destroy(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '{{ url('admin/collection/kckra/destroy') }}' + '/' + id,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(response) {
