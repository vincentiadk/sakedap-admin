	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Edit Pengelolaan Peta</h3><br>
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
							<li class="breadcrumb-item"><a href="#">Peta</a></li>
							<li class="breadcrumb-item"><a href="{{ url('admin/collection/manage/3') }}">Pengelolaan</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('admin/collection/create_manual/3') }}" class="btn btn-primary">Tambah Data Baru</a>
					<a href="{{ url('admin/collection/manage/3') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
												...
												<div class="col-md-6">
													...
													<div class="form-group row">
														...
														<div class="col-md-10">
																...
																<input type="number" name="total_page" id="total_page" class="form-control" placeholder="Masukan total halaman" value="{{ $collection->physicalDescription() ? $collection->physicalDescription()->total_page : '' }}" {{ $collection->lock ? 'disabled' : '' }}>
													...
													<div class="form-group row">
														...
														<div class="col-md-10">
																<input type="text" name="scale" id="scale" class="form-control" placeholder="Masukan skala" value="{{ $collection->physicalDescription() ? $collection->physicalDescription()->scale : '' }}" {{ $collection->lock ? 'disabled' : '' }}>
														</div>
													</div>
													<div class="form-group row">
												...
												<div class="col-md-6">
                                                    ...
                                                    @if($original)
                                                        @if($watermark && count($watermark->jsonParse()) > 0)
                                                            <center>
                                                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                                    <p>Halaman <span id="lblHal"></span> dari  <span id="lblTotal" ></span>
                                                                        <div class="form-group">
                                                                    <a class="btn btn-primary btn-sm" href="#" onclick="prev()"><<</a> <a href="#" class="btn btn-success btn-sm" onclick="next()">>></a>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="number" name="key_carousel"  onchange="loadPdfImage()" min="0" value="1" id="key_carousel"> / <sub id="total_data_image_pdf"></sub>
                                                                </div>
                                                                    <div class="carousel-inner">
                                                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                                            <div class="carousel-inner">
                                                                                <div class="carousel-item active">
                                                                                    <a href="" id="lightbox_image_pdf" data-lightbox="PDF" data-title="Preview PDF"><img class="d-block w-100 ezoom" src="" id="data_image_pdf" style="max-height:903px; width:100%;"></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        @elseif($original->extension == "epub")
                                                            ...
                                                            <div id="epub-area" class="spreads" style="height:903px;"></div>
                                                            <a id="prev" href="#prev" class="arrow btn btn-success">‹</a>
                                                            <a id="next" href="#next" class="arrow btn btn-info">›</a>
                                                        @else
