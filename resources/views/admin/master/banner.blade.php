	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Master Banner</h3><br>
...
<script>
	...
	function loadDataTable() {
		$('#datatable_serverside').DataTable({
			...
			pagingType : 'input',
			ajax: {
				url: '{{ url("admin/banner/datatable") }}'
			},
			columns: [
				{
					name: 'id',
	...
	function destroy(id) {
		Swal.fire({
			...
			if(result.value) {
				$.ajax({
					url: '{{ url("admin/banner/destroy") }}' + '/' + id,
					type: 'GET',
					dataType: 'JSON',
					success: function(response) {
						if(response.status == 200) {
