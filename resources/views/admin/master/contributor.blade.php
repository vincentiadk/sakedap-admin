    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Master Kontributor</h3><br>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Daftar Kontributor</h4>
                            </div>
            ...
            <div class="modal-body">
                ...
                <form action="" id="form_data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="show" id="show" class="form-control select2" style="width:100%;">
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            pagingType: 'input',
            ajax: {
                url: '{{ url('admin/contributor/datatable') }}'
            },
            columns: [{
                    name: 'id',
                    searchable: false,
    ...
    function create() {
        $.ajax({
            url: '{{ url('admin/contributor/create') }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function show(id) {
        toUpdate();
        $.ajax({
            url: '{{ url('admin/contributor/show') }}' + '/' + id,
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                loadingOpen('.modal-content');
            ...
            success: function(response) {
                ...
                $('#show').val(response.show).trigger('change');
    ...
    function update(id) {
        $.ajax({
            url: '{{ url('admin/contributor/update') }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function destroy(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '{{ url('admin/contributor/destroy') }}' + '/' + id,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(response) {
                        if (response.status == 200) {
