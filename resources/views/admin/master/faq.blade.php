    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Master Faq</h3><br>
            ...
            <div class="modal-body">
                ...
                <form action="" id="form_data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="question" id="question" class="form-control" placeholder="Pertanyaan"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Jawaban :</label>
                        <textarea name="answer" id="answer" class="form-control summernote" style="height:70px; resize:none;"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Publish? :</label>
