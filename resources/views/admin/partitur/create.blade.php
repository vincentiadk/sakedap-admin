    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-1 d-inline-block">Tambah Data Partitur</h3><br>
                                    ...
                                    <form id="form_data" class="form">
                                        ...
                                        <p>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="code" id="code" placeholder="Masukan kode ISMN">
                                                </div>
                                            </div>
                                            <div class="form-group row">
...
<script>
    ...
    function create() {
        $.ajax({
            url: '{{ url("admin/collection/create_manual/2") }}',
            type: 'POST',
            dataType: 'JSON',
