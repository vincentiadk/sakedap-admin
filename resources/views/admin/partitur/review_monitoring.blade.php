	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Review Partitur</h3><br>
												...
												<div class="col-md-6">
													<div class="table-responsive">
														<table class="table table-striped table-bordered">
															<tbody>
																<tr>
																	<td class="align-middle w-20 font-weight-bold">Produser</td>
																...
																<tr>
																	<td class="align-middle w-20 font-weight-bold">ISMN</td>
																...
																<tr>
																	...
																	<td class="align-middle">
																		<input type="date" name="received_at" class="form-control" value="{{ date('Y-m-d') }}">
																	</td>
																</tr>
																<tr>
