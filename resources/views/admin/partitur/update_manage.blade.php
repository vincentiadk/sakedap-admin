	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Edit Pengelolaan Partitur</h3><br>
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
							<li class="breadcrumb-item"><a href="#">Partitur</a></li>
							<li class="breadcrumb-item"><a href="{{ url('admin/collection/manage/2') }}">Pengelolaan</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('admin/collection/create_manual/2') }}" class="btn btn-primary">Tambah Data Baru</a>
					<a href="{{ url('admin/collection/manage/2') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
