        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label class="col-md-2">Ekstensi File</label>
                            <div class="col-md-10">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label class="col-md-2">Metode</label>
                            <div class="col-md-10">
                                <select name="method" id="method" class="form-control">
                                    ...
                                    <option value="5">Sistem</option>
                                    <option value="6">Bulk Penerbit</option>
                                    <option value="7">Bulk Admin</option>
                                </select>
                            </div>
                        </div>
                    </div>
