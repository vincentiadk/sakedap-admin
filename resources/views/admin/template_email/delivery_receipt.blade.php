  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-1 d-inline-block">Template Email Bukti Penerimaan</h3><br>
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                  <form action="{{ url('admin/template_email/create_update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="slug" class="form-control" value="template-email-delivery-receipt">
