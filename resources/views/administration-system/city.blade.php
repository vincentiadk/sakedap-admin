    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Kota / Kabupaten</span>
            </h4>
        </div>
        ...
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="mb-0 fw-semibold">Daftar Kota / Kabupaten</h6>
                </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="latitude" id="latitude" placeholder="-6.9175" step="any">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="longitude" id="longitude" placeholder="107.6191" step="any">
                                </div>
                            </div>
                        </div>
                        <small class="form-text text-muted">
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("administration-system/city/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/city/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/city/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/city/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/city/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
