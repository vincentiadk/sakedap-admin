    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Kategori Koleksi</span>
            </h4>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="ph-folders me-2 text-primary"></i>
                    <h6 class="mb-0 fw-semibold">Daftar Kategori Koleksi</h6>
                </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="ph-folder-notch-plus me-2"></i>
            ...
            <div class="modal-body">
                ...
                <form id="form-data" class="form-ajax">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select select2-basic" name="type" id="type" data-dropdown-parent="#modal-form" data-placeholder="Pilih jenis media">
                            <option value=""></option>
                            @foreach($media as $m)
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("administration-system/collection-category/datatable") }}',
                dataType: 'JSON',
                type: 'POST',
                headers: {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/collection-category/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/collection-category/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/collection-category/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/collection-category/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
