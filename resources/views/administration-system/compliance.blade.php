    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Kepatuhan</span>
            </h4>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="ph-check-square me-2 text-primary"></i>
                    <h6 class="mb-0 fw-semibold">Daftar Kepatuhan</h6>
                </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-data" class="form-ajax">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">
                                <i class="ph-number-square-one"></i>
                            </span>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("administration-system/compliance/datatable") }}',
                dataType: 'JSON',
                type: 'POST',
                headers: {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/compliance/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/compliance/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#percentage').val(response.PERSEN);
            },
            error: function(response) {
                onLoading('close', '.modal-content');
                responseError(response);
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/compliance/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/compliance/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
