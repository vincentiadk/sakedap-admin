    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Header Email</span>
            </h4>
        </div>
            ...
            <div class="card-body">
                <div class="alert alert-info border-0 mb-0">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h6 class="mb-1">Informasi Header Email</h6>
                            <p class="mb-1">Header email adalah gambar yang akan ditampilkan di bagian atas setiap email yang dikirim sistem.</p>
                            <ul class="mb-0 mt-2">
                                <li>Format file: JPG, JPEG, atau PNG</li>
                                <li>Ukuran yang disarankan: 600px x 150px</li>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header border-bottom">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="mb-0 fw-semibold">Upload Header Email</h6>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header border-bottom">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="mb-0 fw-semibold">Preview Header Saat Ini</h6>
                    </div>
                </div>
                <div class="card-body">
                    <div class="text-center p-3 bg-light rounded">
                        <img src="{{ url('stream-file') }}?type=gambar_template&id={{ $template->ID }}&filename={{ $template->CONTENT }}" class="img-fluid rounded shadow-sm" alt="Header Email Preview" style="max-height: 200px;">
                    </div>
                    <div class="text-muted text-center mt-2">
                        <small>
                            <i class="ph-info me-1"></i>
                            Ini adalah preview header email yang sedang digunakan
                        </small>
                    </div>
                </div>
            </div>
