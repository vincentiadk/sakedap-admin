    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Kategori Berita</span>
            </h4>
        </div>
        <div class="d-lg-flex ms-lg-auto">
            <div class="d-flex align-items-center">
                <button type="button" class="btn btn-primary" onclick="onCreate()">
                    <i class="ph-folder-plus me-1"></i>
                    Tambah Kategori
                </button>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="ph-folder-open me-1 text-primary"></i>
                    <h6 class="mb-0 fw-semibold">Daftar Kategori Berita</h6>
                </div>
                ...
                <form id="form-data" class="form-ajax">
                    ...
                    <div class="alert alert-info border-0 bg-info bg-opacity-10">
                        <div class="d-flex">
                            ...
                            <div>
                                <h6 class="alert-heading mb-1">Tips Membuat Kategori:</h6>
                                <ul class="mb-0 small">
                                    <li><strong>Nama jelas:</strong> Gunakan nama kategori yang mudah dipahami</li>
                                    <li><strong>Struktur hierarki:</strong> Manfaatkan parent-child untuk organisasi yang baik</li>
                                    <li><strong>Hindari duplikasi:</strong> Pastikan nama kategori tidak sama dengan yang sudah ada</li>
                                    <li><strong>Konsisten:</strong> Gunakan penamaan yang konsisten untuk kategori sejenis</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function onCreate() {
        ...
        $('#modal-title-text').text('Tambah Data Kategori Berita');
    ...
    function onUpdate() {
        ...
        $('#modal-title-text').text('Edit Data Kategori Berita');
        $('#modal-form').modal('show');
    }
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/news-category/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/news-category/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/news-category/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
    ...
    function destroyData(id) {
        var notyConfirm = new Noty({
            text: '<div class="mb-3"><h5 class="text-dark">Hapus Kategori?</h5><span class="text-muted">Data kategori yang telah dihapus tidak bisa dikembalikan lagi. Berita dalam kategori ini tidak akan terhapus.</span></div>',
            timeout: false,
            modal: true,
            layout: 'center',
            closeWith: 'button',
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/news-category/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
