    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Ukuran & Berat Buku</span>
            </h4>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="ph-ruler me-2 text-primary"></i>
                    <h6 class="mb-0 fw-semibold">Daftar Ukuran & Berat Buku</h6>
                </div>
...
<script>
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/size-weight-book/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/size-weight-book/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#price').val(response.FAKTOR_HARGA);
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/size-weight-book/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/size-weight-book/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
