    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Administrasi Sistem - <span class="fw-normal">Ruang Penyimpanan</span>
            </h4>
        </div>
            ...
            <table class="table table-bordered table-hover w-100 display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th class="text-nowrap">Total Koleksi</th>
                        <th class="text-nowrap">Total Rak</th>
                ...
                <form id="form-data" class="form-ajax">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <a href="" data-lightbox="denah-form" data-title="Preview Banner" class="btn btn-success" id="image-preview">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select select2-basic" name="location_library_id" id="location_library_id" data-dropdown-parent="#modal-form">
                            <option value=""></option>
                            @foreach($locationLibrary as $ll)
...
<script>
    ...
    function onReset() {
        ...
        $('#image-preview').hide();
        $('#location_library_id').val('').change();
    }
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("administration-system/storage-space/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("administration-system/storage-space/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("administration-system/storage-space/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#location_library_id').val(response.LOCATIONLIBRARY_ID).change();

                if(response.DENAH) {
                    var paramFile = {
                        id: response.ID,
                        type: 'denah_lokasi',
                        filename: response.DENAH,
                        v: '{{ Str::random(40) }}'
                    };
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("administration-system/storage-space/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: new FormData($('#form-data')[0]),
            contentType: false,
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("administration-system/storage-space/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
