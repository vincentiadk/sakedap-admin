    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Pengawasan & Pembinaan - <span class="fw-normal">Grup Pelaksana Serah</span>
            </h4>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <i class="ph-users-three me-1 text-primary"></i>
                    <h6 class="mb-0 fw-semibold">Daftar Grup Pelaksana Serah</h6>
                </div>
            </div>
        </div>
        <div class="card-body">
...
<script>
    ...
    function onCreate() {
        ...
        $('#modal-title-text').text('Tambah Data Grup Pelaksana Serah');
    ...
    function onUpdate() {
        ...
        $('#modal-title-text').text('Edit Data Grup Pelaksana Serah');
        $('#modal-form').modal('show');
    }
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("coaching-supervision/executor-group/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("coaching-supervision/executor-group/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("coaching-supervision/executor-group/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("coaching-supervision/executor-group/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("coaching-supervision/executor-group/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
