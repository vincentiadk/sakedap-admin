<div class="page-header page-header-light shadow mb-4">
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">Karya Analog</h4>
    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Karya Analog</span>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("collection/analog-work/datatable") }}',
                dataType: 'JSON',
                data: {
                    title: $('#title').val(),
