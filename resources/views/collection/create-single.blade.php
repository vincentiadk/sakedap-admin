                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="physical_description[ill]" id="physical_description[ill]" placeholder="....................">
...
<script>
    ...
    function catalogParent() {
        ...
        $.ajax({
            url: '{{ url("collection/create-single/catalog-parent") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: $('#catalog_id').val()
