    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Pengiriman - <span class="fw-normal">Koleksi Diterima</span>
            </h4>
        </div>
    </div>
</div>
<div class="content pt-0">
    <div class="card">
        ...
        <div class="card-footer bg-white">
            <div class="text-end">
                <a href="{{ url('delivery/accepted') }}" class="btn btn-danger" onclick="onLoading('show', 'body')">
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("delivery/accepted/datatable") }}',
                dataType: 'JSON',
                data: {
    ...
    function detail(id) {
        $.ajax({
            url: '{{ url("delivery/accepted/detail") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
