    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Pengiriman - <span class="fw-normal">Koleksi Ditolak</span>
            </h4>
        </div>
    </div>
</div>
<div class="content pt-0">
    ...
    <div class="card">
        ...
        <div class="card-footer bg-white">
            <div class="text-end">
                <a href="{{ url('delivery/reject') }}" class="btn btn-danger" onclick="onLoading('show', 'body')">
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            ajax: {
                url: '{{ url("delivery/reject/datatable") }}',
                dataType: 'JSON',
                data: {
    ...
    function retur(param = null) {
        ...
        var notyConfirm = new Noty({
            text: '<div class="mb-3"><h5 class="text-dark">Koleksi Dikembalikan?</h5><span class="text-muted">Anda yakin ingin mengembalikan koleksi dalam daftar ini?</span></div>',
            timeout: false,
            modal: true,
            layout: 'center',
            closeWith: 'button',
