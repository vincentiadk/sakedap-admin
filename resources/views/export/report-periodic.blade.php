<table>
    <thead>
        ...
        <tr>
            ...
            <th style="height:25px; border:1px solid black; text-align:left; color:white; vertical-align:center; background:#245DA9;" rowspan="2">Jenis Bahan</th>
            @for($i = 1; $i <= 12; $i++)
