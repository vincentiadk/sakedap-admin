                                    ...
                                    <div class="tab-pane dropdown-scrollable-xl fade p-3 {{ Request::segment(1) == 'physical-delivery' ? 'show active' : '' }}" id="menu-physical-delivery" role="tabpanel">
                                        <div class="row" style="max-height:65vh; overflow-y:auto; overflow-x:hidden;">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <a href="{{ url('physical-delivery/single-verification') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'physical-delivery' && Request::segment(2) == 'single-verification' ? 'active' : '' }}">Verifikasi Per Judul</a>
                                    ...
                                    <div class="tab-pane dropdown-scrollable-xl fade p-3 {{ Request::segment(1) == 'coaching-supervision' ? 'show active' : '' }}" id="menu-coaching-supervision" role="tabpanel">
                                        <div class="row" style="max-height:65vh; overflow-y:auto; overflow-x:hidden;">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{{ url('coaching-supervision/dashboard') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'coaching-supervision' && Request::segment(2) == 'dashboard' ? 'active' : '' }}">Dashboard</a>
                                                ...
                                                <a href="{{ url('coaching-supervision/compliance-v3') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'coaching-supervision' && Request::segment(2) == 'compliance-v3' ? 'active' : '' }}">Kepatuhan V2</a>
                                                <a href="{{ url('administration-system/notification-history') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'administration-system' && Request::segment(2) == 'notification-history' ? 'active' : '' }}">Riwayat Notifikasi Kepatuhan</a>
                                    ...
                                    <div class="tab-pane dropdown-scrollable-xl fade p-3 {{ Request::segment(1) == 'report' ? 'show active' : '' }}" id="menu-report" role="tabpanel">
                                        <div class="row" style="max-height:65vh; overflow-y:auto; overflow-x:hidden;">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{{ url('report/manage') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'report' && Request::segment(2) == 'manage' ? 'active' : '' }}">Penerimaan Digital</a>
                                                <a href="{{ url('report/digital-manage') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'report' && Request::segment(2) == 'digital-manage' ? 'active' : '' }}">Histori Pengelolaan Digital</a>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{{ url('report/recording-performance') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'report' && Request::segment(2) == 'recording-performance' ? 'active' : '' }}">Kinerja Pencatatan Koleksi Fisik</a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <li class="nav-item nav-item-dropdown-lg dropdown me-lg-1">
					...
					<div class="dropdown-menu dropdown-menu-end wmin-lg-400 p-0">
						...
						<div class="d-flex border-top py-2 px-3">
							<a href="{{ url('coaching-supervision/review') }}" class="text-body mx-auto readonly">
								Lihat Selengkapnya
