                                    ...
                                    <div class="tab-pane dropdown-scrollable-xl fade p-3 {{ Request::segment(1) == 'report' ? 'show active' : '' }}" id="menu-report" role="tabpanel">
                                        <div class="row" style="max-height:65vh; overflow-y:auto; overflow-x:hidden;">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{{ url('report/recording-performance') }}" class="dropdown-item rounded pb-0 {{ Request::segment(1) == 'report' && Request::segment(2) == 'recording-performance' ? 'active' : '' }}">Kinerja Pencatatan Koleksi</a>
                                            </div>
                                        </div>
                                    </div>
