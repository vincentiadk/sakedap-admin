    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Master Data - <span class="fw-normal">Media</span>
            </h4>
        </div>
            ...
            <table class="table table-bordered table-hover w-100 display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th class="text-nowrap">Kode Deposit</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-data" class="form-ajax">
                    ...
                    <div class="form-group">
                        <label class="form-label">Kode Deposit :</label>
                        <input type="text" class="form-control" name="code_deposit" id="code_deposit" placeholder="....................">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Kode Barang :</label>
                        <input type="text" class="form-control" name="code_item" id="code_item" placeholder="....................">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select select2-basic" name="worksheet_id" id="worksheet_id" data-dropdown-parent="#modal-form">
                            <option value=""></option>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/media/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/media/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/media/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/media/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/media/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
