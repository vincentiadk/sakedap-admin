	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Tagihan ISBN</h3><br>
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="{{ url('publisher/dashboard') }}">Dashboard</a></li>
							<li class="breadcrumb-item active">Tagihan ISBN</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="card">
							<div class="card-header">
								<div class="row">
											...
											<div class="col-md-10">
												<select name="publisher_id" id="publisher_id" class="form-control">
													@foreach($data['publisher_groups'] as $key => $item)
														<option value="{{ $item->publisher->code_system }}" {{ $key == 0 ? 'selected' : '' }}>{{ $item->publisher->name }}</option>
													@endforeach
												</select>
											</div>
										</div>
									...
									@else
									<input type="hidden" name="publisher_id" id="publisher_id" class="form-control" value="{{ $data['code_system'] }}"/>
									@endif
									<div class="col-md-12">
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<select name="status" id="status" class="form-control">
													<option value="" selected>Semua</option>
													<option value="1">Belum Diserahkan</option>
													<option value="2">Telah Diserahkan</option>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<select name="type_date" id="type_date" class="form-control">
													<option value="" selected>Semua</option>
													<option value="created_date">Tanggal Permintaan ISBN</option>
							...
							<div class="card-header">
								<div class="row">
									<div class="col-md-8">
										...
										<p>Untuk mendapatkan total data tagihan ISBN, silakan gunakan Download Excel. File hasil download dapat Anda lihat pada menu Data Laporan >> File Download </p>
									</div>
							...
							<div class="card-body">
								...
								<div class="tab-content px-1 pt-1">
									<div role="tabpanel" class="tab-pane active" id="tab_detail" aria-expanded="true">
										<p>
											<table class="table table-striped table-bordered display" style="width:1500px;" id="datatable_serverside_detail">
...
<script>
	...
	function loadDataTableSummary(param = '') {
		$('#datatable_serverside_summary').DataTable({
            ...
            iDisplayInLength: 10,
			ajax: {
				url: '{{ url("publisher/bill_isbn/datatable_summary") }}',
				data: {
	...
	function loadDataTableDetail(param = '') {
		$('#datatable_serverside_detail').DataTable({
			...
			pagingType: 'input',
			ajax: {
				url: '{{ url("publisher/bill_isbn/datatable_detail") }}',
				data: {
					param: param,
					type: $('#type').val(),
			...
			columns: [
				{ name: 'kd_penerbit', searchable: false, className: 'text-center align-middle' },
				{ name: 'nama_penerbit', className: 'text-center align-middle' },
				{ name: 'title', className: 'text-center align-middle' },
				{ name: 'jenis', className: 'text-center align-middle' },
				{ name: 'received_date', searchable: false, className: 'text-center align-middle' },
				{ name: 'code', className: 'text-center align-middle' },
				{ name: 'kepeng', className: 'text-center align-middle' },
				{ name: 'created_date', className: 'text-center align-middle' }
			],
		});
	}
