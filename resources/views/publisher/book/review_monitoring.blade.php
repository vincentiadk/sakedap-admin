																...
																<table class="table table-striped table-bordered">
																	<tbody>
																		...
																		<tr>
																			...
																			<td class="align-middle">
																				@if($collection->physicalDescription())
																					{{ isset($collection->physicalDescription()->total_page) ? $collection->physicalDescription()->total_page : '' }} Hal
																				@endif
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td class="align-middle">
																				@if($collection->physicalDescription())
																					{{ isset($collection->physicalDescription()->ilustration) ? $collection->physicalDescription()->ilustration : ''}}
																				@endif
																			</td>
																		</tr>
																		<tr>
																			...
																			<td class="align-middle">
																				@foreach($collection->collectionCategory as $cc)
																					<span class="badge bg-info">{{ isset($cc->category) ?  $cc->category->name : '' }}</span>
																				@endforeach
																			</td>
																		</tr>
																		<tr>
																			...
																			<td class="align-middle">
																				@foreach($collection->collectionSubject as $cs)
																					<span class="badge bg-info">{{ isset($cs->subject) ? $cs->subject->name : '' }}</span>
																				@endforeach
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td class="align-middle">
																				<input type="date" name="received_at" class="form-control" value="{{ date('Y-m-d', strtotime($collection->received_at)) }}" max="{{ date('Y-m-d') }}" disabled>
																			</td>
																		</tr>
																		<tr>
