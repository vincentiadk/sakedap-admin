  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-1 d-inline-block">Pemantauan Film</h3><br>
      ...
      <section id="configuration">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Daftar Pemantauan Film</h4>
...
<script>
  ...
  function loadDataTable() {
    $('#datatable_serverside').DataTable({
      ...
      ajax: {
        url: '{{ url("publisher/collection/monitoring/datatable/6") }}',
        data: {
