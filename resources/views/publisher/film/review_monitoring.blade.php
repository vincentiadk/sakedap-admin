  ...
  <div class="content-wrapper">
	<div class="content-header row">
	  <div class="content-header-left col-md-6 col-12 mb-2">
		<h3 class="content-header-title mb-1 d-inline-block">Review Pemantauan Film</h3><br>
		<div class="row breadcrumbs-top d-inline-block">
		  <div class="breadcrumb-wrapper col-12">
			<ol class="breadcrumb">
			  ...
			  <li class="breadcrumb-item"><a href="{{ url('publisher/collection/monitoring/6') }}">Pemantauan</a></li>
	  ...
	  <div class="content-header-right col-md-6 col-12 mb-2 mt-1">
		<div class="float-md-right">
		  <a href="{{ url('publisher/collection/monitoring/6') }}" class="btn btn-secondary">Kembali</a>
		</div>
	  </div>
	</div>
						...
						<p>
						  <div class="table-responsive">
							<table class="table table-striped table-bordered">
								...
								<tr>
								  <th colspan="2">
									<div class="row justify-content-center">
									  <div class="col-md-8">
										@php $original = $collection->collectionMedia->where('type', 7)->first(); @endphp
										  ...
										  <center>
											<div class="embed-responsive embed-responsive-16by9">
											  <video width="100%" height="240" controls>
												<source src="{{ asset(Storage::url($original->link)) }}" type="{{ $original->mimes }}">
							  ...
							  <tbody>
								<tr>
								  <td class="align-middle w-20 font-weight-bold">Rumah Produksi</td>
								...
								<tr>
								  <td class="align-middle w-20 font-weight-bold">ISAN</td>
								...
								<div class="col-md-6">
								  ...
								  <div class="alert alert-success mb-2 w-100 align-middle" role="alert">
									<fieldset class="radio">
									  <label>
										<input type="radio"  name="access" value="1"> Akses full file berwatermak secara online
									  </label>
									</fieldset>
								  </div>
								  <div class="alert alert-success mb-2 w-100 align-middle" role="alert">
									<fieldset class="radio">
									  <label>
										<input type="radio"  name="access" value="2" > Akses hanya preview file secara online, namun tetap dapat di dayagunakan di lingkungan perpustakaan nasional RI dengan jaringan internet LAN
									  </label>
									</fieldset>
								  </div>
								  <div class="alert alert-success mb-2 w-100 align-middle" role="alert">
