				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('publisher/collection/monitoring/3') }}">Peta Direview</a></li>
													...
													<div class="alert alert-secondary w-100">
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label>Preview:</label>
																	@php $original = $collection->collectionMedia->where('type', 3)->first(); @endphp
																	@if($watermark && count($files) > 0)
																		<input type="text" name="preview" id="preview" class="form-control" placeholder="Ex: 1-3" value="{{ $collection->preview }}">
																	@else
																	 @if(isset($original) && $original->status == 0)
																			<div class="alert alert-danger">
																				<ul>
																					<li>File Preview sedang di proses</li>
																				</ul>
																			</div>
																		@else
																			<div class="alert alert-danger">
