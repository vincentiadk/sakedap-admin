	...
	<div class="content-header row">
		...
		<div class="row breadcrumbs-top d-inline-block">
		  <div class="breadcrumb-wrapper col-12">
			<ol class="breadcrumb">
			  ...
			  <li class="breadcrumb-item"><a href="{{ url('publisher/collection/problem/3') }}">Peta Bermasalah</a></li>
	  ...
	  <div class="content-header-right col-md-6 col-12 mb-2 mt-1">
		<div class="float-md-right">
		  <a href="{{ url('publisher/collection/problem/3') }}" class="btn btn-secondary">Kembali</a>
		</div>
	  </div>
	</div>
