        ...
        <div class="row breadcrumbs-top d-inline-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="#">Notifikasi</a></li>
            </ol>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label>Isi</label>
            <div id="body" class="card" style="padding: 10px;"></div>
          </div>
      </div>
...
<script>
  ...
  function loadDataTable() {
    $('#datatable_serverside').DataTable({
      ...
      ajax: {
        url: '{{ url("publisher/notification/datatable") }}',
        data: {
  ...
  function showDetail(id) {
    ...
    $("#body").html('')
    $.ajax({
        url: '{{ url("publisher/notification/read/") }}/' + id,
        type: 'GET',
        dataType: 'JSON',
        cache: false,
        contentType: false,
