          ...
          <div class="content-header-right col-md-6 col-12 mb-2 mt-1">
              <div class="float-md-right">
                  <div class="form-group">
                    ...
                    <a href="{{ url('template/partitur/partitur_bulk.zip') }}" class="btn btn-success">Download Template</a></p>
                  </div>
              </div>
          </div>
      </div>
...
<script>
  $(document).ready(function() {
    const date = Date.now();
    const fileName = 'partitur_collection_' + "{{ $data['publisher']->id }}_" + date + '.zip'
