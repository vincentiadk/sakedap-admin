	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-1 d-inline-block">Review Pemantauan Partitur</h3><br>
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('publisher/collection/monitoring/2') }}">Pemantauan</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('publisher/collection/monitoring/2') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
											...
											<div role="tabpanel" class="tab-pane active" id="tab_general" aria-expanded="true">
												<p>
													<div class="row">
														...
														<div class="col-md-6">
															@php
															$orignal = $collection->collectionMedia->where('type', 2)->first();
