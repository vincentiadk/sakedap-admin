		...
		<div class="content-header row">
				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('publisher/collection/problem/2') }}">Partitur Bermasalah</a></li>
			...
			<div class="content-header-right col-md-6 col-12 mb-2 mt-1">
				<div class="float-md-right">
					<a href="{{ url('publisher/collection/problem/2') }}" class="btn btn-secondary">Kembali</a>
				</div>
			</div>
		</div>
												...
												<p>
													<div class="row">
														<div class="col-md-6">
															...
															<div class="form-group">
																<label>Skala :</label>
																	<input type="text" name="scale" id="scale" class="form-control" placeholder="Masukan skala" value="{{ $collection->physicalDescription() ? $collection->physicalDescription()->scale : '' }}" >
															</div>
															<div class="form-group">
																<label>Dimensi :</label>
																<div class="input-group mb-2">
