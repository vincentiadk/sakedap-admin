          ...
          <div class="content-header-right col-md-6 col-12 mb-2 mt-1">
              <div class="float-md-right">
                  <div class="form-group">
                    ...
                    <a href="{{ url('template/serial/serial_bulk.zip') }}" class="btn btn-success">Download Template</a></p>
                  </div>
              </div>
          </div>
      </div>
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <form id="form_data" class="steps-validation wizard-circle">
                    ...
                    <h6>Upload File</h6>
                    <fieldset>
                      <input type="hidden" name="collection_id" id="collection_id" value="{{ Request::input('id') }}">
...
<script>
  $(document).ready(function() {
    const date = Date.now();
    const fileName = 'serial_collection_' + "{{ $data['publisher']->id }}_" + date + '.zip'
