						...
						<div class="card">
							...
							<div class="card-content collapse show">
								<div class="card-body card-dashboard">
									<form action="{{ url('publisher/collection/monitoring/review/' . $collection->id) }}" method="POST" class="form-horizontal">
										@csrf
														...
														<table class="table table-striped table-bordered">
															<tbody>
																...
																<tr>
																	...
																	<td class="align-middle">
																		@if($collection->physicalDescription())
																			{{ isset($collection->physicalDescription()->dimension) ? $collection->physicalDescription()->dimension : '' }} Cm
																		@endif
																	</td>
																</tr>
																<tr>
