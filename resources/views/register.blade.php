              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form id="form_data" class="form-horizontal steps-validation wizard-circle">
                      {!! csrf_field() !!}
                      <!-- Step 1 -->
                      <h6>Pelaksana Serah</h6>
                      <fieldset>
                        <div class="form-group">
                          <label>Nama Pelaksana Serah</label>
                          <input type="text" name="name" class="form-control " id="name" placeholder="Nama Pelaksana Serah" required="" minlength="5">
                        </div>
                        <div class="form-group category-element">
                          <label>Kategori Pelaksana Serah</label>
                          <fieldset class="radio">
                            <label>
                              <input type="radio"  name="category" value="1"> Swasta
                            </label>
                          </fieldset>
                          <fieldset class="radio">
                            <label>
                              <input type="radio"  name="category" value="3"> Pemerintah
                            </label>
                          </fieldset>
                          <fieldset class="radio">
                            <label>
                              <input type="radio"  name="category" value="2"> Perorangan
                            </label>
                          </fieldset>
                        </div>
                        <div class="form-group"  id="col-surat">
                          <label>Pernyataan
                            <a href="{{url('/main/surat-pernyataan.doc')}}" target="_blank" class="btn btn-info btn-sm"><i class="la la-file"></i>Unduh Form</a>
                          </label>
                          <div class="custom-file border border-light">
                            <label class="file center-block align-middle">
                              <input type="file" id="file_surat" name="surat" class="w-100" id="inputGroupFileP" accept=".pdf" required="" style="margin-top: 5px;margin-left: 10px;">
                              <span class="file-custom"></span>
                            </label>
                          </div>
                        </div>
                        <div class="form-group" id="col-akta">
                      ...
                      <fieldset>
                        <div class="form-group">
                          <label>Alamat</label>
                          <textarea name="address" class="form-control " id="address" placeholder="Isi Sesuai KTP" required=""></textarea>
                        </div>
                        <div class="form-group">
                            <label>Provinsi</label>
                            <select name="province_id" id="publisher_province" class="form-control required" style="width:100%;" required=""></select>
                        </div>
                        <div class="form-group">
                            <label>Kota/Kab</label>
                            <select name="city_id" id="publisher_city" class="form-control required" style="width:100%;" required=""></select>
                        </div>
                        <div class="form-group">
                            <label>Kecamatan</label>
                            <select name="district_id" id="publisher_district" class="form-control required" style="width:100%;" required=""></select>
                        </div>
                        <div class="form-group">
                            <label>Kelurahan</label>
                            <select name="village_id" id="publisher_village" class="form-control required" style="width:100%;" required=""></select>
                        </div>
                        <div class="form-group">
                          <div class="input-group">
                            <input type="text" name="phone_number" class="form-control " id="phone_number"  placeholder="0211234456/081123123123" required="">
                        </div>
                        <div class="form-group">
                          <label>Fax</label>
          ...
          success: function(response) {
              ...
              if(response.status == 200) {
                  ...
                  $.each(response.error, function(i, val) {
                      $('#validasi_content').append('<li>' + val + '</li><br/>');
                  });
              } else {
                  Toast.fire({
                      icon: 'warning',
