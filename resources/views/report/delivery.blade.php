            ...
            <table class="table table-bordered table-hover w-100 display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th class="text-nowrap" rowspan="2">Tgl Pengiriman</th>
                        <th class="text-nowrap" rowspan="2">Nomor Pengiriman</th>
                        <th class="text-nowrap" rowspan="2">Tgl Terima</th>
                        <th class="text-nowrap" rowspan="2">Pengirim</th>
                        <th class="text-nowrap" rowspan="2">No HP</th>
                        <th class="text-nowrap" rowspan="2">Pelaksana Serah</th>
                        <th class="text-nowrap" rowspan="2">Nomor UT</th>
                        ...
                        <th class="text-nowrap" rowspan="2">Kode Promo</th>
