    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Pengaturan - <span class="fw-normal">Konfigurasi</span>
            </h4>
        </div>
    </div>
</div>
<div class="content pt-0">
    ...
    @endif
    <form action="{{ url('setting/configuration/submitted') }}" method="POST" onsubmit="onLoading('show', 'body')">
        @csrf
        <div class="card">
            <div class="card-body">
...
<script>
    function testSendEmail() {
        $.ajax({
            url: '{{ url("setting/configuration/test-send-email") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
